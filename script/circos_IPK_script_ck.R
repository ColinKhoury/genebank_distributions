...
country_regions <- read_excel('D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/countries_regions/Countries_gb_data_regions_2015_10_15.xlsx', sheet=1); country_regions <- as.data.frame(country_regions)
data_country <- read_excel("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/IPK_OriginCountry_ToCountry_circos_2015_10_9_final.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/interchange_IPK_10_years.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/interchange_IPK_10_years.csv", row.names = 1)
...
n <- nrow(df1)
# Include RGB color
colors <- read.csv("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/id_colors_regions.csv")
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/PGR_interdependence/analysis/Genebank_distributions/inputs/IPK/interchange_IPK_all.pdf",sep=""), height=10, width=10)
