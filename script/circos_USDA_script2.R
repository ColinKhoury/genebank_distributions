...
data_country <- read_excel("F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/USDA_newfinal_OriginCountry_ToCountry_circos.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/Prod_items_country_regions.csv")
...
write.csv(data_country, "F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/interchange_USDA_10_years.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/interchange_USDA_10_years.csv", row.names = 1)
...
dev.copy2pdf(file=paste("F:/CIAT/Interdependence/Circos_analysis_Colin_26-09-2015/_data/_send5/results/interchange_USDA_all.pdf",sep=""), height=10, width=10)
