...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/AAFC_Origincountry-Tocountry_circosfinal_2016_2_4_avannual.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/Prod_items_country_regions_uscansep.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/Prod_items_country_regions_uscansep.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/regions_sourceofprod_uscansep.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/regions_sourceofprod_uscansep.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannaul_canussep1.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannaul_canussep1.csv", row.names = 1)
...
df1$xmax[which(df1$region=="IOI")] <- 1
df1$xmax[which(df1$region=="Pac")] <- 1
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannual_all_canussep1b.pdf",sep=""), height=10, width=10)
