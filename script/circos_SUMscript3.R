...
country_regions <- read_excel('D:/Tobackup/_hmcfw/Genebank_distributions/inputs/countries_regions/Countries_gb_data_regions_2016_6_13_canussep.xlsx', sheet=1); country_regions <- as.data.frame(country_regions)
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/ALL_Origincountry-Tocountry_circosfinal_2016_4_19_avannual_normalmethod.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/regions_sourceofprod.csv")
...
regions <- read.csv('D:/Tobackup/_hmcfw/Genebank_distributions/inputs/prep_files/regions_24list_uscansep.csv')
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/interchange_ALL.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/interchange_ALL.csv", row.names = 1)
...
n <- nrow(df1)
# Include RGB color
colors <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/prep_files/id_colors_regions_USCANSEP.csv")
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/interchange_ALL_all.pdf",sep=""), height=10, width=10)
