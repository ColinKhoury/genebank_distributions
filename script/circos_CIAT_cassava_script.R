...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/CIAT_Origincountry_tocountry_circos_2016_1_9b_cassava.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/interchange_CIATcassava_avannual.csv",sep=""),row.names=TRUE)
...
origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/interchange_CIATcassava_avannual.csv", row.names=1)
...
df1$xmax[which(df1$region=="NE\nEur")] <- 1
df1$xmax[which(df1$region=="SE\nEur")] <- 1
df1$xmax[which(df1$region=="C\nAsia")] <- 1
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/cassava/interchange_CIATcassava_avannual_all.pdf",sep=""), height=10, width=10)
