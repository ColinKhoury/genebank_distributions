...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/USDA_OriginCountry_ToCountry_circos_final2016_1_6_avannual.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/interchange_USDA.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/interchange_USDA.csv", row.names = 1)
...
#colors$region <- gsub(pattern='Car', replacement='Caribbean', x=colors$region, fixed=TRUE)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/USDA_NPGS/interchange_USDA_all.pdf",sep=""), height=10, width=10)
