...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/CIAT_Origincountry_tocountry_circos_2016_1_9b_forages.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/interchange_CIATforages_avannual.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/interchange_CIATforages_avannaul.csv", row.names = 1)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/interchange_AGG_all.pdf",sep=""), height=10, width=10)
