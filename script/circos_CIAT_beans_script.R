...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/CIAT_Origincountry_tocountry_circos_2016_2_23_beans_avannual.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/regions_sourceofprod.csv")
...
regions <- read.csv('D:/Tobackup/_hmcfw/Genebank_distributions/inputs/regions_23list.csv')
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/interchange_CIATbeans.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/interchange_CIATbeans.csv", row.names = 1)
...
n <- nrow(df1)
# Include RGB color
colors <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/id_colors_regions.csv")
...
colors$region <- gsub(pattern='C\\nAmer', replacement='C\nAmerica and Mexico', x=colors$region, fixed=TRUE)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/beans/interchange_CIATbeans_all.pdf",sep=""), height=10, width=10)
