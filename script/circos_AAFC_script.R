...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannaul.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannaul.csv", row.names = 1)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannual_all.pdf",sep=""), height=10, width=10)
