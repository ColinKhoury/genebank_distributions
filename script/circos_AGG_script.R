...
country_regions <- read_excel('D:/Tobackup/_hmcfw/Genebank_distributions/inputs/countries_regions/Countries_gb_data_regions_2016_1_9.xlsx', sheet=1); country_regions <- as.data.frame(country_regions)
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/AGG_origincountry_tocountry_circos_final2016_1_6_avannual.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/regions_sourceofprod.csv")
...
cOrgData_region$R_recipients <- gsub(pattern=regions[2], replacement='Australia\nand New Zealand', cOrgData_region$R_recipients, fixed=TRUE)
...
cOrgData_region$R_origin <- gsub(pattern=regions[2], replacement='Australia\nand New Zealand', cOrgData_region$R_origin, fixed=TRUE)
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/interchange_AGG_avannual_fix1.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/interchange_AGG_avannual_fix1.csv", row.names = 1)
...
n <- nrow(df1)
# Include RGB color
colors <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/id_colors_regions_AGG1.csv")
colors <- colors[,c("Region","r","g","b")]
names(colors)[1] <- "region"
colors$region <- as.character(colors$region)

colors$region <- gsub(pattern='N\\nAmerica', replacement='N\nAmerica', x=colors$region, fixed=TRUE)
colors$region <- gsub(pattern='C\\nAmerica', replacement='C\nAmerica', x=colors$region, fixed=TRUE)
...
colors$region <- gsub(pattern='Australia\\nand New Zealand', replacement='Australia\nand New Zealand', x=colors$region, fixed=TRUE)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AGG/interchange_AGG_avannual_fixed1_all.pdf",sep=""), height=10, width=10)
