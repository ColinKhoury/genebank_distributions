...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannaul_canussep.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannaul_canussep.csv", row.names = 1)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/AAFC/interchange_AAFC_avannual_all_canussep.pdf",sep=""), height=10, width=10)
