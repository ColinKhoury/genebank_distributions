...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/CGIAR_andCIAT_OriginCountry_ToCountry_circos_final2016_2_23_avannual.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/interchange_CGIARandCIAT.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/interchange_CGIARandCIAT.csv", row.names = 1)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/SUM/CGIAR_andCIAT/interchange_CGIARandCIAT_all.pdf",sep=""), height=10, width=10)
