...
data_country <- read_excel("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/CIAT_Origincountry_tocountry_circos_2016_2_5_forages.xlsx", sheet=1); data_country <- as.data.frame(data_country)
...
# Guardar
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/Prod_items_country_regions.csv", row.names=FALSE)
rm(country_regions, data_country)

g=gc(); rm(list=ls())

# Leerlo
data_exp <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/Prod_items_country_regions.csv")
...
write.csv(data_country, "D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/regions_sourceofprod.csv",row.names=FALSE)
...
cOrgData_region <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/regions_sourceofprod.csv")
...
write.csv(origin_regions,paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/interchange_CIATforages.csv",sep=""),row.names=TRUE)

origin_regions <- read.csv("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/interchange_CIATforages.csv", row.names = 1)
...
dev.copy2pdf(file=paste("D:/Tobackup/_hmcfw/Genebank_distributions/inputs/CIAT/forages/interchange_CIATforages_all.pdf",sep=""), height=10, width=10)
